...
# -------------------------------
# Utility: Orthogonal Initialization
# -------------------------------
...
class Actor_RNN(nn.Module):
    def __init__(self, args, actor_input_dim):
        ...
        if args.use_orthogonal_init:
            print("Using orthogonal initialization for Actor_RNN")
...
class Actor_MLP(nn.Module):
    def __init__(self, args, actor_input_dim):
        ...
        if args.use_orthogonal_init:
            print("Using orthogonal initialization for Actor_MLP")
            orthogonal_init(self.fc1)
...
class Critic_RNN(nn.Module):
    def __init__(self, args, critic_input_dim):
        ...
        self.activate_func = [nn.Tanh(), nn.ReLU()][args.use_relu]
        if args.use_orthogonal_init:
            print("Using orthogonal initialization for Critic_RNN")
            orthogonal_init(self.fc1)
            orthogonal_init(self.rnn)
            orthogonal_init(self.fc2)
...
class Critic_MLP(nn.Module):
    def __init__(self, args, critic_input_dim):
        ...
        self.activate_func = [nn.Tanh(), nn.ReLU()][args.use_relu]
        if args.use_orthogonal_init:
            print("Using orthogonal initialization for Critic_MLP")
            orthogonal_init(self.fc1)
            orthogonal_init(self.fc2)
...
# -------------------------------
# MAPPO MULTIWALKER with Integrated Owen Reward Allocation
# -------------------------------
class MAPPO_MULTIWALKER:
    def __init__(self, args):
        ...
        # Input dimensions for actor and critic networks
