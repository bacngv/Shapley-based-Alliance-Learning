...
class MAPPO_MULTIWALKER:
    ...
    def train(self, replay_buffer, total_steps):
        ...
        # Re-allocate rewards using computed Shapley values for each time step
        ...
        # Update alliance networks based on sampled observations
        ...
        # Compute and return average allocated (Shapley) reward and true reward for monitoring
