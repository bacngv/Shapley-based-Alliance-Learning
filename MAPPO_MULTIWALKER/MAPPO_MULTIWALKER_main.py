...
from matplotlib.ticker import FuncFormatter  # For formatting x-axis labels
...
class Runner_MAPPO_MULTIWALKER:
    def __init__(self, args, env_name, number, seed):
        ...
        # Set reference dimensions using the first agent
        ...
        self.evaluate_rewards = []  # Evaluation rewards
        self.eval_steps = []        # Corresponding training steps
        self.total_steps = 0

        # Set GIF saving threshold (every 20k steps)
